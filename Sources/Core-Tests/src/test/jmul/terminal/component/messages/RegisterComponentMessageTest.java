...
import jmul.terminal.component.messages.RegisterComponentMessage;


/**
 * This test suite tests the properties of a register component message.
 *
 * @author Kristian Kutin
 */
@UnitTest
public class RegisterComponentMessageTest {

    /**
     * Tests all standard properties of a register component message, except the creation date.
     */
    @Test
    public void testCreatingMessage() {
        ...
        RegisterComponentMessage message = new RegisterComponentMessage(sender, receiver);
        ...
        assertEquals(RegisterComponentMessage.REGISTER_COMPONENT_TOPIC, message.topic());
        ...
        assertEquals(RegisterComponentMessage.REGISTER_COMPONENT_TOPIC, message.get(StandardPropertyKeys.TOPIC));
    }

    /**
     * Tests the creation date property of a register component message.
     */
    @Test
    ...
    public void testAddState() {
        ...
        String sender = "sender";
        String receiver = "receiver";
        RegisterComponentMessage receivedMessage = new RegisterComponentMessage(sender, receiver);
        State state = ComponentStates.READY;

        RegisterComponentMessage message = new RegisterComponentMessage(receivedMessage, state);
